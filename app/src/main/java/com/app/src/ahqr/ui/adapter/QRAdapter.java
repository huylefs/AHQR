package com.app.src.ahqr.ui.adapter;

import static com.app.src.ahqr.utils.DateTimeConverters.fromTimestamp;
...
public class QRAdapter extends RecyclerView.Adapter<QRAdapter.MyQRViewHolder> {
    ...
    public QRAdapter(Context context, List<MyQR> cityClocks, QRAdapter.OnItemClickListener listener) {
